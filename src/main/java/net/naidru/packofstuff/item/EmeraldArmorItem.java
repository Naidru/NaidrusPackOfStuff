...
public class EmeraldArmorItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:emerald_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_packostuff:emerald_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_packostuff:emerald_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_packostuff:emerald_armorboots")
	public static final Item boots = null;
	public EmeraldArmorItem(NaidruPackostuffModElements instance) {
		super(instance, 116);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(CTabArmorItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "naidru_packostuff:textures/models/armor/emerald_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
