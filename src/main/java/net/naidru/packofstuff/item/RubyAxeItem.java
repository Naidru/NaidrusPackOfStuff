...
public class RubyAxeItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:ruby_axe")
	public static final Item block = null;
	public RubyAxeItem(NaidruPackostuffModElements instance) {
		super(instance, 92);
	}
