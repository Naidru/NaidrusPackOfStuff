...
public class JungleArmorItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:jungle_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_packostuff:jungle_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_packostuff:jungle_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_packostuff:jungle_armorboots")
	public static final Item boots = null;
	public JungleArmorItem(NaidruPackostuffModElements instance) {
		super(instance, 49);
	}
