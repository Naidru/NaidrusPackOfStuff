...
public class CopperIngotItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(NaidruPackostuffModElements instance) {
		super(instance, 180);
	}
