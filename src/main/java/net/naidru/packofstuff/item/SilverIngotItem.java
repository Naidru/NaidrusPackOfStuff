...
public class SilverIngotItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:silver_ingot")
	public static final Item block = null;
	public SilverIngotItem(NaidruPackostuffModElements instance) {
		super(instance, 243);
	}
