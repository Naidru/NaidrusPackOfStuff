...
public class OakArmorItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:oak_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_packostuff:oak_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_packostuff:oak_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_packostuff:oak_armorboots")
	public static final Item boots = null;
	public OakArmorItem(NaidruPackostuffModElements instance) {
		super(instance, 34);
	}
