...
public class SaphireGemItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:saphire_gem")
	public static final Item block = null;
	public SaphireGemItem(NaidruPackostuffModElements instance) {
		super(instance, 66);
	}
