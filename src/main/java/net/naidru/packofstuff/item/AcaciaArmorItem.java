...
public class AcaciaArmorItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:acacia_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_packostuff:acacia_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_packostuff:acacia_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_packostuff:acacia_armorboots")
	public static final Item boots = null;
	public AcaciaArmorItem(NaidruPackostuffModElements instance) {
		super(instance, 54);
	}
