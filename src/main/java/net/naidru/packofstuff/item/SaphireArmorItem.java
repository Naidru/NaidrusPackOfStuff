...
public class SaphireArmorItem extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:saphire_armorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("naidru_packostuff:saphire_armorbody")
	public static final Item body = null;
	@ObjectHolder("naidru_packostuff:saphire_armorlegs")
	public static final Item legs = null;
	@ObjectHolder("naidru_packostuff:saphire_armorboots")
	public static final Item boots = null;
	public SaphireArmorItem(NaidruPackostuffModElements instance) {
		super(instance, 80);
	}
