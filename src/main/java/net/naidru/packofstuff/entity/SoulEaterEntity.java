...
public class SoulEaterEntity extends NaidruPackostuffModElements.ModElement {
	public static EntityType entity = null;
	public SoulEaterEntity(NaidruPackostuffModElements instance) {
		super(instance, 176);
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new SpiderModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("naidru_packostuff:textures/soul_eater.png");
			}
		});
	}
