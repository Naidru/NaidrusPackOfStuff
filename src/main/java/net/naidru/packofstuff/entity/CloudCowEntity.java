...
public class CloudCowEntity extends NaidruPackostuffModElements.ModElement {
	public static EntityType entity = null;
	public CloudCowEntity(NaidruPackostuffModElements instance) {
		super(instance, 265);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.9f, 1.4f)).build("cloud_cow")
						.setRegistryName("cloud_cow");
		elements.entities.add(() -> entity);
		elements.items.add(
				() -> new SpawnEggItem(entity, -3355444, -6710887, new Item.Properties().group(CTabMobsItemGroup.tab)).setRegistryName("cloud_cow"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new CowModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("naidru_packostuff:textures/cloud_cow.png");
			}
		});
	}
