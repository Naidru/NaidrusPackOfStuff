...
public class CloudChickenEntity extends NaidruPackostuffModElements.ModElement {
	public static EntityType entity = null;
	public CloudChickenEntity(NaidruPackostuffModElements instance) {
		super(instance, 272);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(44).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.4f, 0.7f)).build("cloud_chicken")
						.setRegistryName("cloud_chicken");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -10526881, -65536, new Item.Properties().group(CTabMobsItemGroup.tab))
				.setRegistryName("cloud_chicken"));
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> new MobRenderer(renderManager, new ChickenModel(), 0.5f) {
			...
			public ResourceLocation getEntityTexture(Entity entity) {
				return new ResourceLocation("naidru_packostuff:textures/cloud_chicken.png");
			}
		});
	}
