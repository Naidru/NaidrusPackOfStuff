...
public class SkyOreBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:sky_ore")
	public static final Block block = null;
	public SkyOreBlock(NaidruPackostuffModElements instance) {
		super(instance, 142);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}), block.getDefaultState(), 1)).withPlacement(Placement.COUNT_RANGE.configure(new CountRangeConfig(2, 146, 146, 256))));
		}
	}
}
