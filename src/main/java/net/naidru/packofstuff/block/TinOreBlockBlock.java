...
public class TinOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:tin_ore_block")
	public static final Block block = null;
	public TinOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 200);
	}
