...
import net.naidru.packofstuff.item.TopazGemItem;
...
public class TopazOreBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:topaz_ore")
	public static final Block block = null;
	public TopazOreBlock(NaidruPackostuffModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TopazGemItem.block, (int) (1)));
		}
	}
	@Override
