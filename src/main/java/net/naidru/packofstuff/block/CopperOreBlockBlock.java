...
public class CopperOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:copper_ore_block")
	public static final Block block = null;
	public CopperOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 179);
	}
