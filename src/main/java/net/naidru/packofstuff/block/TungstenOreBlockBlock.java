...
public class TungstenOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:tungsten_ore_block")
	public static final Block block = null;
	public TungstenOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tungsten_ore_block");
		}
