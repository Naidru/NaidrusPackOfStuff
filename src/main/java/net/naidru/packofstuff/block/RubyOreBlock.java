...
public class RubyOreBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:ruby_ore")
	public static final Block block = null;
	public RubyOreBlock(NaidruPackostuffModElements instance) {
		super(instance, 85);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubyGemItem.block, (int) (1)));
		}
	}
	@Override
