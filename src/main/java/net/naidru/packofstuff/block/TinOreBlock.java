...
import net.naidru.packofstuff.item.TinIngotItem;
...
public class TinOreBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:tin_ore")
	public static final Block block = null;
	public TinOreBlock(NaidruPackostuffModElements instance) {
		super(instance, 199);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TinIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}.withConfiguration(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("tin_ore", "tin_ore", blockAt -> {
