...
public class AmethystOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:amethyst_ore_block")
	public static final Block block = null;
	public AmethystOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 316);
	}
