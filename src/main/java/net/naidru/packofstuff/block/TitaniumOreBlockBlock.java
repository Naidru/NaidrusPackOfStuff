...
public class TitaniumOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:titanium_ore_block")
	public static final Block block = null;
	public TitaniumOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 274);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("titanium_ore_block");
		}
