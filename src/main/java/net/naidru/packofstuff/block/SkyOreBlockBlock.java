...
public class SkyOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:sky_ore_block")
	public static final Block block = null;
	public SkyOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 143);
	}
