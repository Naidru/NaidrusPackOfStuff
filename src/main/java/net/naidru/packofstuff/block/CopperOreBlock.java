...
public class CopperOreBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(NaidruPackostuffModElements instance) {
		super(instance, 178);
	}
