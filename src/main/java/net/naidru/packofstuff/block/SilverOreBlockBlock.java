...
public class SilverOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:silver_ore_block")
	public static final Block block = null;
	public SilverOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 242);
	}
