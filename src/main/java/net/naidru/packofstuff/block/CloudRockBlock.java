...
public class CloudRockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:cloud_rock")
	public static final Block block = null;
	public CloudRockBlock(NaidruPackostuffModElements instance) {
		super(instance, 267);
	}
