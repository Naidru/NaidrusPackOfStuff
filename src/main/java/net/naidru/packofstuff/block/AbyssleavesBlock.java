...
public class AbyssleavesBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:abyssleaves")
	public static final Block block = null;
	public AbyssleavesBlock(NaidruPackostuffModElements instance) {
		super(instance, 7);
	}
