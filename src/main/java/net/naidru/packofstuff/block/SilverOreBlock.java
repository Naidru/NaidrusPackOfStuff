...
import net.naidru.packofstuff.item.SilverIngotItem;
...
public class SilverOreBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:silver_ore")
	public static final Block block = null;
	public SilverOreBlock(NaidruPackostuffModElements instance) {
		super(instance, 241);
	}
