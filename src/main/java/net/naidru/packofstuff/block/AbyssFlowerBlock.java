...
public class AbyssFlowerBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:abyss_flower")
	public static final Block block = null;
	public AbyssFlowerBlock(NaidruPackostuffModElements instance) {
		super(instance, 341);
	}
