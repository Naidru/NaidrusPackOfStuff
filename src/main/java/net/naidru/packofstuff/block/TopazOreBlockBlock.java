...
public class TopazOreBlockBlock extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:topaz_ore_block")
	public static final Block block = null;
	public TopazOreBlockBlock(NaidruPackostuffModElements instance) {
		super(instance, 122);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("topaz_ore_block");
		}
