...
package net.naidru.packofstuff.world.structure;
...
public class AbyssigniterStructureThingStructure extends NaidruPackostuffModElements.ModElement {
	public AbyssigniterStructureThingStructure(NaidruPackostuffModElements instance) {
		super(instance, 271);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 200) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("naidru_packostuff", "abyssigniter"));
						if (template == null)
							return false;
