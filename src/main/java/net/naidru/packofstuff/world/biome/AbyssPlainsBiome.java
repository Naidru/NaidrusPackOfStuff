...
public class AbyssPlainsBiome extends NaidruPackostuffModElements.ModElement {
	@ObjectHolder("naidru_packostuff:abyss_plains")
	public static final CustomBiome biome = null;
	public AbyssPlainsBiome(NaidruPackostuffModElements instance) {
		super(instance, 174);
	}
			...
			addFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
					new CustomTreeFeature()
							.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(AbyssLogBlock.block.getDefaultState()),
									new SimpleBlockStateProvider(AbyssleavesBlock.block.getDefaultState()))).baseHeight(8)
